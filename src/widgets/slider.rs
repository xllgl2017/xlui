...
impl Slider {
    pub fn new(v: f32) -> Slider {
        ...
        Slider {
            ...
            callback: None,
            contact_ids: vec![],
            fill_render: RenderParam::new(RectParam::new(Rect::new().with_size(114.0, 6.0), fill_style)),
            slider_render: RenderParam::new(CircleParam::new(Rect::new().with_size(16.0, 16.0), slider_style)),
            slided_render: RenderParam::new(RectParam::new(Rect::new().with_size(114.0, 6.0), slided_style)),
            focused: false,
            hovered: false,
            offset: 0.0,
            changed: false,
